...
INSERT INTO tb_regra (descricao, permissao) VALUES ('Permissâo de CRUD algumas para algumas entidades. Não ter permissão de CRUD para usuários e regras.','ADMIN_PRODUTOS');
